...
class ModelsTest(TestCase):
    def setUp(self):
        self.user, _ = get_user_model().objects.get_or_create(username='testuser', defaults={'password': 'testpassword'})
    ...
    def test_class_model(self):
        trainer = Trainer.objects.create(name='Test Trainer', speciality='Test Speciality')
        class_instance = Class.objects.create(class_name='Test Class', trainer=trainer, class_date='2023-01-01', start_time='12:00:00', end_time='13:00:00')
    ...
    def test_membership_model(self):
        client = Client.objects.create(name='Test Client', address='Test Address', phone='1234567890')
        membership = Membership.objects.create(client=client, start_date='2023-01-01', end_date='2023-12-31', cost=100.00)
    ...
    def test_subscription_model(self):
        ...
        trainer = Trainer.objects.create(name='Test Trainer', speciality='Test Speciality')
        class_instance = Class.objects.create(class_name='Test Class', trainer=trainer, class_date='2023-01-01', start_time='12:00:00', end_time='13:00:00')
        subscription = Subscription.objects.create(client=client, class_field=class_instance, subscription_date='2023-01-01')
